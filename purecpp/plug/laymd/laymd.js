layui.define(['jquery'], function(exports) {
    ...
    var tools = {
        ...
        link: '<i class="laymd-tool-link" title="超链接" laymd-event="link">link</i>',
        code: '<i class="laymd-tool-code" title="代码" laymd-event="code">code</i>',
        ...
        full: '<i class="laymd-tool-full" title="全屏" laymd-event="full">分屏</i>',
        preview: '<i class="laymd-tool-preview" title="预览" laymd-event="preview">预览</i>'
    };
