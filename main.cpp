...
int main(){
	...
	server.set_http_handler<GET>("/category", &purecpp_controller::category, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/search", &purecpp_controller::search, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<POST>("/comment", &purecpp_controller::comment, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/remove_comment", &purecpp_controller::remove_comment, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/login_page", &purecpp_controller::login_page, &purecpp_ctl, enable_cache{ false });
	...
	server.set_http_handler<GET, POST>("/sign_out_page", &purecpp_controller::sign_out_page, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/sign_out", &purecpp_controller::sign_out, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/quit", &purecpp_controller::quit, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/member_edit_page", &purecpp_controller::member_edit_page, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/member_edit", &purecpp_controller::member_edit, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/my_post", &purecpp_controller::my_post, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/remove_post", &purecpp_controller::remove_post, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/edit_post_page", &purecpp_controller::edit_post_page, &purecpp_ctl, enable_cache{ false });
	server.set_http_handler<GET, POST>("/edit_post", &purecpp_controller::edit_post, &purecpp_ctl, enable_cache{ false });
