...
int main(){
	...
	server.set_http_handler<POST>("/search", &purecpp_controller::search, &purecpp_ctl);
	...
	server.set_http_handler<GET, POST>("/logout_page", &purecpp_controller::logout_page, &purecpp_ctl);
